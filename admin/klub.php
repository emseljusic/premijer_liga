...
{
	?> 
	<p><a href="dodajIgraca.php">Dodaj igrača</a></p>
...
<tr><td><b>Trener: </b><?php
 $sql1="select trener_ime, trener_prezime, id_trener from trener where klub_id='$id_klub'";
 $query1=mysql_query($sql1);
 while($row1=mysql_fetch_assoc($query1)){
	 ?><a href="editTrener.php?id=<?php echo $row1['id_trener'];?>"><?php echo $row1['trener_ime'];
	 echo " ";
	 echo $row1['trener_prezime'];?></a>
<?php }
?></td></tr>
<tr><td><a href="editKlub.php?id=<?php echo $id_klub; ?>">Uredi Klub</a></td></tr>
</tbody>
</table>
<section>
<?php
