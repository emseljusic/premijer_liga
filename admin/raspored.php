...
<table class="table table-striped" style="background-color: white; width:50%; border-radius:20px" align="center">
	...
	<tr>	
		...
		<td style="width:10%"><center><a href="editUtak.php?id=<?php echo $row['id_utakmica']; ?>">_-_</a></center></td>
	...
	<tr>
		...
		<td style="width:10%"><center><a href="editUtak.php?id=<?php echo $firstrow['id_utakmica']; ?>">_-_</a></center></td>
