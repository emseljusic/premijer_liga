...
<body>
<div class="container" style="padding-top:5px;padding-left:400px;">
      <div class="row">
          <div class="col-md-6">
            <div class="span4 offset4 well">
<form method="post">	
		Korisnički naziv: <input type="text" name="naziv_korisnik" class="form-control" required="" value="<?php echo $naziv_korisnik; ?>">
